...
namespace Api.UnitTests.Filters.BadRequestExceptionFilter
{
    [TestClass]
    public class BadRequestExceptionFilterUnitTests
    {
        ...
        [TestMethod]
        public void SetsBadRequestResultWhenActionThrowsBadRequestException()
        {
            const string message = "BAD_REQUEST";
            ...
            _mock.Mock<IExceptionContext>()
                ...
                .Returns(new BadRequestException(message));

            var filter = _mock.Create<Api.Filters.BadRequestExceptionFilter.BadRequestExceptionFilter>();
